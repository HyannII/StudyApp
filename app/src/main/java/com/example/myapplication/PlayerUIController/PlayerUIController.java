package com.example.myapplication.PlayerUIController;
...
public class PlayerUIController extends AbstractYouTubePlayerListener {
    ...
    public PlayerUIController(View controlsUi, YouTubePlayer youTubePlayer, YouTubePlayerView youTubePlayerView){
    ...
    private void initViews(View view){
        ...
        seekBar.setYoutubePlayerSeekBarListener(youTubePlayer::seekTo);
        pausePlay.setOnClickListener(v -> {
            if(playerTracker.getState() == PlayerConstants.PlayerState.PLAYING){
                pausePlay.setImageResource(R.drawable.play_circle);
                youTubePlayer.pause();
            }else{
        ...
        fullScreen.setOnClickListener(v -> {
            if(isFullScreen) youTubePlayerView.wrapContent();
        ...
        relativeLayout.setOnClickListener(v -> fadeViewHelper.toggleVisibility());
        container.setOnClickListener(v -> fadeViewHelper.toggleVisibility());
    }
